...
[![GoDoc](https://godoc.org/github.com/rohanthewiz/rotatelogs?status.svg)](https://godoc.org/github.com/rohanthewiz/rotatelogs)


Port of [File::RotateLogs](https://metacpan.org/release/File-RotateLogs) from Perl to Go.

_Caution: This is a copy of the archived repo: github.com/lestrrat/go-file-rotatelogs.
This is not currently actively maintained_.
...
import (
  ...
  rotatelogs "github.com/rohanthewiz/rotatelogs"
)
...
When you integrate this to your app, it automatically writes to logs that
...
```
go get github.com/rohanthewiz/rotatelogs
```
