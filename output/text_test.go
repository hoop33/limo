...
func ExampleText_Star() {
	...
	homepage := "https://github.com/lucmski/limo"
	url := "https://github.com/lucmski/limo.git"
	star := &model.Star{
		FullName:    &fullName,
		Stargazers:  1000000,
		Language:    &language,
	...
	text.Star(star)
	// Output:
	// hoop33/limo *:1000000 Go https://github.com/lucmski/limo.git
	// cli, git
	// A CLI for managing starred Git repositories
	// Home page: https://github.com/lucmski/limo
